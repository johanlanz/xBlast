...
public enum Block {
    ...
    /**
     * Construit un bloc. Ce constructeur est fait pour les block bonus. le paramètre passé en argument devient 
     * l'attribut bonus de l'instance
     * @param maybeAssociatedBonus bonus associé au block
     */
