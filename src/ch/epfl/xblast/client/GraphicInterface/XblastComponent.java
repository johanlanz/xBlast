package ch.epfl.xblast.client.GraphicInterface;
...
public final class XblastComponent extends JComponent {
     ...
     * 
     * Pour la suite, on a définit un comparateur qui vérifie la coordonnées y des joueurs et si le 2ème est plus grande que le 1er il mettra le deuxième avant. //TODO verifier la logique
     ...
     * sinon 1 pour le mettre aussi avant. Si aucun des deux est égal on retourne 0. 
     * 
    ...
    protected void paintComponent(Graphics g0){
        ...
        Comparator<Player> playerC = new Comparator<Player>() {
            ...
            public int compare(Player p1, Player p2) {
                Integer p1y = p1.position().y();
                Integer p2y = p2.position().y();
                return p2y.compareTo(p1y);// TODO trouver meilleur comparateur
            }
