...
public final class GameState {
    ...
    public GameState(List<Player> players, List<Image> board, List<Image> explosions, List<Image> scores, List<Image> time){
     ...
     /**
      * @return une copie de liste des joueurs 
      */
    public List<Player> players(){
        return new ArrayList<Player>(players);
    }
    /**
     * @return une copie de liste des images du board 
     */
    public List<Image> board(){
        return new ArrayList<Image>(board);
    }
    /**
     * @return une copie de liste des images des explosions sur le board 
     */
    ...
    /**
     * @return une copie de liste des images représentant le score 
     */
    public List<Image> scores(){
        return new ArrayList<Image>(scores);
    }
    /**
     * @return une copie de liste des images du temps 
     */
